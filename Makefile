...
pkgdatadir = $(datadir)/gdv
pkglibdir = $(libdir)/gdv
pkgincludedir = $(includedir)/gdv
...
MOC = @MOC@
MSGFMT = @MSGFMT@
NOOPT_CXXFLAGS =  -O0 -g3 -Wall -I/users/students/in11013/include/SDL -D_REENTRANT
NOREPO = -fno-repo
OBJDUMP = @OBJDUMP@
OBJEXT = o
PACKAGE = gdv
